#+TITLE: Setting Up Zambia from Scratch or New Event
#+EMAIL: NELA.Percy@gmail.com
#+AUTHOR: Percy, Bendyogagirl
#+DATE: July 2011
#+DESCRIPTION: Zambia is a piece of Conference Management Software.  This document is a "How To" guide to help set up your Zambia FFF-branch instance from scratch or set up another con instance in your Zambia FFF-branch instance for your conference.  This is still a work in progress.
#+MACRO: DESCRIPTION Zambia is a piece of Conference Management Software.  This document is a "How To" guide to help set up your Zambia FFF-branch instance from scratch or set up another con instance in your Zambia FFF-branch instance for your conference.  This is still a work in progress.
...
*** Web server
    ...
    the like.
*** [[../Local/db_name.php][db_name.php]] file

    This information will go in the db_name.php file when you install it.
    + date_default_timezone_set your timezone.  Mine is set to:
      ('US/Eastern')
    + Base session dir (*BASESESSIONDIR*), which is important for
    ...
    + Vendor information database name (*VENDORDB*).  The database
    ...
    + The fallback keying tag (*FALLBACK_KEY*) and URL
      (*FALLBACK_URL*) which is useful when there isn't a specified
      or remembered con instance to be referenced.
    + The language list (*LANGUAGE_LIST*) which is the list of
...
*** ConInfo table
    ...
    + Con short name.
    + Con long name.
    + Number of days the con will run (code has been tested for 1-8.)
    ...
    + Logo for the con (gif, png, etc.)  This is based from the tcpdf
    ...
    + Grid Spacer (The time divisions in the fixed grid produced, in
      ...
      default.)
    + Are kids available (This should probably be set to "FALSE", it
      is a hold-over from backwards compatibility.)
    + Preferred total number of sessions upper limit (so your
      presenters don't oversubscribe themselves 5 is good default for
      a 3-4 day con.)
    + Preferred daily number of sessions upper limit (3 is a good
      default.)
    + Availability Records (starting number of "availability" fields
...
*** Very useful information
    ...
    You don't need the information for setup, but it is good to have.
     ...
     + Brainstorm email - goes in the Brainstorm Person's account.
     + Programming email - goes in the Programming Person's account.
     + Guests of Honor badge list - if you have specific featured Guests
       of Honor, they get indicated as a con role.
*** Language Settings

     The linguistic settings can be used if your con is in more than
     one language.
     + What the second language is, and it's indicator (fr-ca, en-uk)
     + What will and won't be translated.
* Downloading
  ...
  https://github.com/mrdkap/Zambia
* Local file setup
...
** db_name.php
   ...
   Copy the example [[../webpages/db_name_sample.php][db_name_sample.php]] to [[../Local/db_name.php][Local/db_name.php]]
...
#+end_src
   ...
   [[../webpages/StaffManageParticipants.php]["Manage Participants & Schedule"]] tab, there is an
   [[../webpages/AdminParticipants.php]["Administer participants"]] link to the [[../webpages/AdminParticipants.php]["AdminParticipants.php"]] page.
   ...
   [[../webpages/StaffEditCreateParticipant.php?action=create]["Enter Participants"]] link to the
...
** Schedule
   ...
   [[../webpages/genreport.php?reportname=tasklistdisplay][genreport.php?reportname=tasklistdisplay]] report.
...
#+end_src
* Adding a year instance - Tools

  + Con Creation: [[../webpages/AdminNewConInstance.php][AdminNewConInstance.php]]
  + Con Info: [[../webpages/AdminConInstance.php][AdminConInstance.php]]
  + Phase state: [[../webpages/AdminPhases.php][AdminPhases.php]]
  + Permissions/Con Role: [[../webpages/StaffEditCreateParticipant.php?action=migrate][Migrate Participant]], [[../webpages/StaffEditCreateParticipant.php?action=edit][Edit Participant]]
  + Has Reports: [[../webpages/AdminHasReports.php][AdminHasReports.php]]
  + Manage Participants and Schedule: [[../webpages/StaffManageParticipants.php][Manage Participants & Schedule]]
  + Publication Limits: [[../webpages/AdminPublicationLimits.php][AdminPublicationLimits.php]]
  + Services and Features: [[../webpages/AdminSetupServices.php][AdminSetupServices.php]]
  + Create Sessions: [[../webpages/CreateSession.php][Create a New Session]]
  + Manage Sessions: [[../webpages/StaffManageSessions.php][Manage Sessions]]
  + Manage Feedback: [[../webpages/AdminSetupFeedback.php][AdminSetupFeedback.php]]
  + WebApp information update: [[../webpages/KonOpasData.php][Publish to KonOpas/WebApp]]
* Adding a year instance - Con Structure
  ...
  the [[../webpages/AdminNewConInstance.php]["AdminNewConInstance.php"]] page.  This takes care of letting you
  ...
  [[../webpages/AdminConInstance.php]["AdminConInstance.php"]] page.

  This (the [[../webpages/AdminConInstance.php]["AdminConInstance.php"]] page) is also where you would go if
  there is a missing value from one of the Base tables, which are:
  + BaseDigitalAd - Ads and Promotions
  + BaseFeatures - Schedule Elements
  + BaseLocBuilding - Locations
  + BaseLocFloor - Locations
  + BaseLocRoom - Rooms
  + BaseLocSubRoom - Rooms
  + BasePrintAd - Ads and Promotions
  + BaseServices - Schedule Elements
  + BaseSponsorLevel - Ads and Promotions
  + BaseVendorFeature - Vendors
  + BaseVendorSpace - Vendors

  If you want to modify the ConInfo table by hand, here are the
  updates you have to do.  You might also want to update the
  FALLBACK_KEY in the [[../Local/db_name.php]["db_name.php"]] file, but you shouldn't have
...
#+end_src
   ...
   + conname: The short name of your con (probably including either
     the number, or the year of your con or other unique identifier).
   + connamelong: The long name of your con, what people would
...
** Phase
   ...
   [[../webpages/AdminPhases.php]["AdminPhases.php"]] page and the appropriate phase changes state.  If
...
* Adding a year instance - People
  ...
  [[./Presenter_Flow.html]["Presenter Flow"]] [[./Presenter_Flow.pdf][(PDF)]] document in this directory.
** UserHasPermissionRole
   ...
   because of the use of the [[../webpages/AdminNewConInstance.php]["AdminNewConInstance.php"]] page, above.

   Of course, tweaking from year to year might need to happen.  The
   easiest way to do so is to use the 
   [[../webpages/StaffEditCreateParticipant.php?action=migrate]["Migrate Participant from another con-instance"]] link under the
   [[../webpages/StaffManageParticipants.php]["Manage Participants & Schedule"]] tab which brings you to the
   [[../webpages/StaffEditCreateParticipant.php?action=migrate]["StaffEditCreateParticipant.php?action=migrate"]] page.
   ...
   listed above, or on the [[../webpages/StaffEditCreateParticipant.php?action=edit]["Edit Participant"]] page. The use of that
   page is well documented in the [[./Presenter_Flow.html]["Presenter Flow"]] [[./Presenter_Flow.pdf][(PDF)]] document in
   this directory.
...
** UserHasConRole
   ...
   populated by the use of the use of the [[../webpages/AdminNewConInstance.php]["AdminNewConInstance.php"]]
   page, above, and can be modified on either the [[../webpages/StaffEditCreateParticipant.php?action=migrate]["Migrate Participant"]]
   page or the [[../webpages/StaffEditCreateParticipant.php?action=edit]["Edit Participant"]] page mentioned above.
...
** HasReports
   ...
   be prepopulated when you used the [[../webpages/AdminNewConInstance.php]["AdminNewConInstance.php"]] or can
   be modified as your con goes on using the [[../webpages/AdminHasReports.php]["AdminHasReports.php"]]
...
** Continued Interaction
   ...
   [[../webpages/StaffManageParticipants.php]["Manage Participants & Schedule"]] page.
* Adding a year instance - Sessions

  The sessions are mostly generated from Brainstorm, proposals by
  presenters, and by the [[../webpages/CreateSession.php]["Create a New Session"]] page, but there are a
...
** PublicationLimits
   ...
   [[../webpages/genreport.php?reportname=publicationlimits]["genreport.php?reportname=publicationlimits"]] report.

   To add/update the limits for this event, feel free to use the
   [[../webpages/AdminPublicationLimits.php]["AdminPublicationLimits.php"]] page.  Each limit is findable under
...
** Services and Features
   ...
   available for this con-instance, use the [[../webpages/AdminSetupServices.php]["AdminSetupServices.php"]]
   page.

   To add a service or feature that you expect to be listed is not
   listed from that page, use the [[../webpages/AdminConInstance.php]["AdminConInstance.php"]] page (if you
...
** Continued Interaction
   ...
   Most of the continued interaction can be mostly handled under the
   [[../webpages/StaffManageSessions.php]["Manage Sessions"]] page.
* Adding a year instance - Vendors

  This is covered extensively, and in a more updated fashion in the
  [[./Vending_Design_Document.html]["Vending Design Document"]] [[./Vending_Design_Document.pdf][(PDF)]].
* Adding a year instance - Feedback
  ...
  Most everything can be done from the [[../webpages/AdminSetupFeedback.php]["AdminSetupFeedback.php"]] page.
...
** Setting the Types available on a Feedback Page
...
** Adding Questions Types
   ...
   + questiontypenotes: A more in depth description of the question type.
** Adding specific Questions in a Question Type
...
* Adding a year instance - App/KonOpas
  ...
  the [[../webpages/KonOpasData.php]["Publish to KonOpas/WebApp"]] link off of the [[../webpages/StaffManageSessions.php][Manage Sessions]] page.
* Other Useful Documentation
  + [[./Bio_Editing.html][Bio Editing]] [[./Bio_Editing.pdf][(PDF)]]
  + [[./Email_Functions.html][Email Functions]] [[./Email_Functions.pdf][(PDF)]]
  + [[./Panelists_Guide.html][Panelists Guild]] [[./Panelists_Guide.pdf][(PDF)]]
  + [[./Photo_Lounge.html][Photo Lounge Guide]] [[./Photo_Lounge.pdf][(PDF)]]
  + [[./Presenter_Flow.html][Presenter Flow]] [[./Presenter_Flow.pdf][(PDF)]]
  + [[./Publication_Flow.html][Publication Flow]] [[./Publication_Flow.pdf][(PDF)]]
  + [[./Tasks-Gantt_Chart.html][Tasks and Gantt Chart]] [[./Tasks-Gantt_Chart.pdf][(PDF)]]
  + [[./Time_Card.html][Time Cards]] [[./Time_Card.pdf][(PDF)]]
  + [[./Vending_Design_Document.html][Vending Guide]] [[./Vending_Design_Document.pdf][(PDF)]]
