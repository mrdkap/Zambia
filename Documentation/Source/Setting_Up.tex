...
\hypersetup{
  ...
  pdfsubject={Zambia is a piece of Conference Management Software.  This document is a "How To" guide to help set up your Zambia FFF-branch instance from scratch or set up another con instance in your Zambia FFF-branch instance for your conference.  This is still a work in progress.},
  pdfcreator={}}
\begin{document}
...
\chead{
Setting Up Zambia from Scratch or New Event
}
\lfoot{
...
To add/update the limitsThis still needs an in-Zambia tool to modify/set these.
