...
\begin{itemize}
\item badgeid: The unique id of an individual in Zambia.
\item permroleid: A role that an individual will have for this con.
...
The values are:
\begin{itemize}
\item serviceid/featureid: Unique id for the entry (key).
\item servicename/featurename: A description of the thing available.
