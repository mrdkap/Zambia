...
\hypersetup{
  ...
  pdfsubject={Zambia is a piece of Conference Management Software.  This document is a "How To" guide to using the Task List and Gantt Chart in the Zambia FFF-branch instance for your conference.  This is still a work in progress.
