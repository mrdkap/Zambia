...
**** VENDORQA [[../webpages/VendorAdminState.php][VendorAdminState.php]]
...
**** VENDORQA [[../webpages/VendorApply.php][VendorApply.php]]
...
**** VENDORQA [[../webpages/VendorSubmitVendor.php][VendorSubmitVendor.php]] [[../webpages/StaffManageBios.php][StaffManageBios.php]]
*** Invoice
...
**** VENDORQA [[../webpages/VendorPayAdj.php][VendorPayAdj.php]]
*** Vendor Jury
...
*** Vendor Placement
    ...
    - Three Pieces:
**** VENDORQA [[../webpages/VendorSetupLocation.php][VendorSetupLocation.php]]
     This sets the possible rooms, times, division, (possible) track,
     key, map, and general information for the locations to be in.
**** VENDORQA [[../webpages/VendorAssignSpace.php][VendorAssignSpace.php]] (top form)
...
**** VENDORQA [[../webpages/VendorAssignSpace.php][VendorAssignSpace.php]] (bottom form)
     Map Placement.
...
**** VENDORQA [[../webpages/VendorSetupSpaceFeature.php][VendorSetupSpaceFeature.php]]
*** Adminsiter Ad/Sponsor Options
    ...
    event basis.
    - needs removal option
**** VENDORQA [[../webpages/PubsSetupAds.php][PubsSetupAds.php]]
*** Administer Vendor
...
**** VENDORQA [[../webpages/VendorApply.php][VendorApply.php]] [[../webpages/VendorSubmitVendor.php][VendorSubmitVendor.php]] [[../webpages/StaffManageBios.php][StaffManageBios.php]]
...
** Flow
   ...
   on the [[../webpages/StaffManageVendors.php][StaffManageVendors.php]] page.
*** Set Amenities
    Go to the [[../webpages/VendorSetupSpaceFeature.php][VendorSetupSpaceFeature.php]] page, and set the
...
*** Set Location possibilities
    Go to the [[../webpages/VendorSetupLocation.php][VendorSetupLocation.php]] page, and set the appropriate
    locations available for the vendors.
*** Task List - Vendors
    Create Task List elemement at [[../webpages/TaskListUpdate.php?activityid=-1][TaskListUpdate.php?activityid=-1]]
...
*** Email
    ...
    Might use [[../webpages/StaffSendEmailCompose.php][StaffSendEmailCompose.php]]
*** Phase Change
    At the appropriate time, the Con Chair or Zambia Librarian opens
    the call for vendors, in line with the appropriate task-list
    activities from the [[../webpages/AdminPhases.php][AdminPhases.php]] page.
*** Email
    Vendor Div Head generates and sends email letting the
    vendors/community tables know that the call is open.
    Possibly using a mailing list, or using [[../webpages/StaffSendEmailCompose.php][StaffSendEmailCompose.php]]
...
*** (If Rolling Acceptance) Jury
    ...
    Tools: 
     + [[../webpages/genindex.php?gflowname=Vend][genindex.php?gflowname=Vend]]
     + [[../webpages/VendorAdminState.php][VendorAdminState.php]]
     + [[../webpages/VendorSubmitVendor.php][VendorSubmitVendor.php]]
     + [[../webpages/VendorApply.php][VendorApply.php]]
     + Other tools TBD.
    Otherwise ...
*** Phase Change
    At the appropriate time, the Con Chair or Zambia Librarian closes
    the call for vendors. (This is not necessarily in the right place
    in the sequence.)  From the [[../webpages/AdminPhases.php][AdminPhases.php]] page.
*** Jury
    ...
    general booth type is to be assigned on the [[../webpages/VendorAssignSpace.php][VendorAssignSpace.php]]
    page, and any pay adjustment is to be done on the [[../webpages/VendorPayAdj.php][VendorPayAdj.php]]
    page.
...
*** Placement
    ...
    the day of the event on the [[../webpages/VendorAssignSpace.php][VendorAssignSpace.php]]
*** Email
    ...
    [[../webpages/StaffSendEmailCompose.php][StaffSendEmailCompose.php]] page.
*** Welcome Letter
...
*** Post Con Final Email
    Sent, possibly using [[../webpages/StaffSendEmailCompose.php][StaffSendEmailCompose.php]] page or
    the mailing list.
