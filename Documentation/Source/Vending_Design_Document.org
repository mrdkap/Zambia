...
**** VENDORQA needs to be vetted/tested.
...
**** VENDORQA in pieces
***** DONE first report - Vendor State change
      Which allows for changing the Vendor State is done.
***** DONE second report - List of those with PDFs
...
*** Vendor Placement
    ...
    - Two Pieces.
**** TODO Initial vendor booth type selection  Need before Invoicing
