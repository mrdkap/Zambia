...
*** this year's check
**** DONE combination of badgeid and conid to avoid multiple entries in a year.
*** id - varchar(15)
...
**** DONE a list of digital advertizing for this year, the prices, and the conid (DigitalAd)
...
**** DONE a list of digital advertizing for this year, the prices, and the conid (SponsorLevel)
...
**** DONE VendorSpace based on VendorSpaces
     - This year's options, based on VendorSpaces
...
*** Returning Vendor sign-in
    ...
    - not for this year, but subequent years.
...
**** VENDORQA Proposed (1) / Applied (2)
     ...
     appropriate year information on it.
     - Waiting on Vendor QA of the words, and the contract.
**** TODO NELA Approved (3)
     ...
     PDF.
     - Still needs PDF and Submission form.
**** TODO Warwick Invoced (4)
...
**** TODO Warwick Approval (6)
     ...
     - Still needs update form, probably inserted, for ease rather
       than an click-through.
**** TODO NELA Invoiced (7)
...
**** VENDORQA NELA Denied (10)
     For those vendors who just didn't make the cut (this year?)
     usually would happen after (or instead of) the NELA Approved (3)
     state.
**** VENDORQA Warwick Denied (11)
     For those vendors who didn't make Warwick's cut this year (and
     can they apply again, subsequent years?  Are we going to track
...
*** Administer Vendor Options
    Page that has the Amenities and Spaces for this year, pulled from
...
*** Set Amenities
    ...
    appropriate amenities/prices/et al for this year.
*** Set Spaces
    Go to the VendorSetupSpaceFeature.php page, and set the
    appropriate spaces/prices/et al for this year.
