...
\subsubsection{this year's check}
\label{sec-2-2-1}
\begin{itemize}
\item {\bfseries\sffamily DONE} combination of badgeid and conid to avoid multiple entries in a year.
\label{sec-2-2-1-1}
\end{itemize}
...
\item {\bfseries\sffamily DONE} a list of digital advertizing for this year, the prices, and the conid (DigitalAd)
\label{sec-2-2-5-2}
\begin{itemize}
...
\item {\bfseries\sffamily DONE} a list of digital advertizing for this year, the prices, and the conid (SponsorLevel)
\label{sec-2-2-6-2}
\begin{itemize}
...
\label{sec-2-2-18-2}
\begin{itemize}
\item This year's options, based on VendorSpaces
...
\subsubsection{Vendor Yearly Variables}
\label{sec-2-5-2}
\begin{itemize}
...
\begin{itemize}
\item not for this year, but subequent years.
\end{itemize}
\begin{itemize}
\item {\bfseries\sffamily TODO} needs to be finished
\label{sec-3-1-1-1}
\begin{itemize}
...
their email address
\begin{itemize}
\item not for this year, but yes
\end{itemize}
\begin{itemize}
...
\item {\bfseries\sffamily TODO} Warwick Approval (6)
\label{sec-3-1-5-5}
...
\begin{itemize}
\item Still needs update form, probably inserted, for ease rather
