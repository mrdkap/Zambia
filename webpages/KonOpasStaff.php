...
<h1><a href="KonOpas.php?conid=<?php echo $conid ?>#info" alt="<?php echo $connamelong ?>" title="<?php echo $connamelong ?>">
...
<ul id="tabs">
<li id="tab_star"><a href="KonOpas.php?conid=<?php echo $conid ?>#star" data-txt>My con</a>
<li id="tab_prog"><a href="#" data-txt>Job Descriptions</a><div id="day-sidebar" class="sub-side"></div>
<li id="tab_part"><a href="#part" data-txt>Staff</a><div id="part-sidebar" class="sub-side"></div>
<li id="tab_info"><a href="KonOpas.php?conid=<?php echo $conid ?>#info" data-txt>Info</a>
</ul>
...
if ($phase_array['General Info Available'] == '0') {
   echo "<script src=\"../Local/$conid/staffjobs.js\"></script>\n";
