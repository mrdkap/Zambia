...
<?php
    $i=0;
    while (list($sessionid,$trackname,$title,$duration,$desc_good_web,$desk_good_book,$persppartinfo,$rbadgeid)= mysql_fetch_array($result, MYSQL_NUM)) {
        echo "        <TR>\n";
...
if (may_I('my_panel_interests')) {
        ...
        echo "        <TR><TD colspan=3 class=\"border0010\">Web: ".htmlspecialchars($desc_good_web,ENT_NOQUOTES)."</TD></TR>\n";
        echo "        <TR><TD colspan=3 class=\"border0010\">Book: ".htmlspecialchars($desc_good_book,ENT_NOQUOTES)."</TD></TR>\n";
