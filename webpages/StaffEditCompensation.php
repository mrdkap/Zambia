...
if ($_POST['update']=="please") {
  ...
  if (isset($_POST['compids']) and ($_POST['compids']!='')) {
	...
	$compamount="compamount='".mysqli_real_escape_string($link,stripslashes($_POST[$compid]))."'";
      }
      if ($_POST['d_'.$compid] != $_POST['was_d_'.$compid]) {
	$compdescription="compdescription='".mysqli_real_escape_string($link,stripslashes($_POST['d_'.$compid]))."'";
      }
