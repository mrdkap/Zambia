...
if ($_POST['update']=="please") {
  ...
  $pairedvalue_array=array("phototitle='".mysqli_real_escape_string($link,stripslashes(htmlspecialchars_decode($_POST["phototitle"])))."'",
			   "photoartist='".mysqli_real_escape_string($link,stripslashes(htmlspecialchars_decode($_POST["photoartist"])))."'",
			   "photomodel='".mysqli_real_escape_string($link,stripslashes(htmlspecialchars_decode($_POST["photomodel"])))."'",
			   "photoloc='".mysqli_real_escape_string($link,stripslashes(htmlspecialchars_decode($_POST["photoloc"])))."'",
			   "photonotes='".mysqli_real_escape_string($link,stripslashes(htmlspecialchars_decode($_POST["photonotes"])))."'",
