...
$query= <<<EOD
SELECT
    DISTINCT concat("<A HREF=StaffTrackScheduleIcal.php?trackid=",trackid,">",trackname,"</A>") AS "Tracks"
  FROM
      Tracks
    JOIN Sessions USING (trackid)
...
$filename=str_replace(" ","_",$schdarray[1]["trackname"]);
