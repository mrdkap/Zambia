...
function SubmitCommentOnProgramming () {
    ...
    $value_array = array($_SESSION['badgeid'],$_SESSION['conid'],mysqli_real_escape_string($_POST['commenter']),mysqli_real_escape_string($_POST['comment']));
...
function SubmitCommentOnParticipants () {
    ...
    $value_array = array($_POST['partid'],$_SESSION['badgeid'],$_SESSION['conid'],mysqli_real_escape_string($_POST['commenter']),mysqli_real_escape_string($_POST['comment']));
...
function SubmitCommentOnSessions () {
    ...
    $value_array = array($_POST['sessionid'],$_SESSION['conid'],$_SESSION['badgeid'],mysqli_real_escape_string($_POST['commenter']),mysqli_real_escape_string($_POST['comment']));
