...
if (($_POST['submit'] == "Update") AND ($locationid != "")) {
  ...
  if ($_POST['remove']=="remove") {
	...
	$pairedvalue_array[]="$i=\"" . mysqli_real_escape_string($link,stripslashes($_POST[$i])) . '"';
      }
    }
  ...
  $element_array = array('baselocbuildingid', 'baselocfloorid', 'baselocroomid',
			 ...
			 'locationdimensions', 'locationarea', 'locationnotes',
			 'display_order');
  $value_array = array(mysqli_real_escape_string($link,stripslashes($_POST['baselocbuildingid'])),
		       mysqli_real_escape_string($link,stripslashes($_POST['baselocfloorid'])),
		       mysqli_real_escape_string($link,stripslashes($_POST['baselocroomid'])),
		       mysqli_real_escape_string($link,stripslashes($_POST['baselocsubroomid'])),
		       mysqli_real_escape_string($link,stripslashes($_SESSION['conid'])),
		       mysqli_real_escape_string($link,stripslashes($_POST['divisionid'])),
		       mysqli_real_escape_string($link,stripslashes($_POST['trackid'])),
		       mysqli_real_escape_string($link,stripslashes($_POST['locationkey'])),
		       mysqli_real_escape_string($link,stripslashes($_POST['locationmap'])),
		       mysqli_real_escape_string($link,stripslashes($_POST['locationheight'])),
		       mysqli_real_escape_string($link,stripslashes($_POST['locationdimensions'])),
		       mysqli_real_escape_string($link,stripslashes($_POST['locationarea'])),
		       mysqli_real_escape_string($link,stripslashes($_POST['locationnotes'])),
		       mysqli_real_escape_string($link,stripslashes($_POST['display_order'])));
  $message.=submit_table_element($link, $title, "Location", $element_array, $value_array);
}
